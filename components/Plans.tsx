...
const Plans = () => {
  return (
    <div id="plans" className=" w-full lg:h-[130vh] h-full flex flex-col" >
        ...
        <div className="plans-container w-full h-[80%] flex justify-center items-center flex-col py-3 lg:py-0 ">
          <div className=" w-[90%] h-[90%] flex flex-col lg:flex-row lg:gap-x-4 gap-y-4 lg:gap-y-0 ">
            <div className="buttons bg-white flex items-center justify-center  w-full lg:h-full h-80 border-2 lg:hover:translate-y-10 lg:hover:scale-105 lg:hover:rounded-t-md group transition duration-300 relative rounded-xl border-[#FF7A30] ">
            ...
            <div className="buttons bg-white flex items-center justify-center w-full h-full border-2 rounded-xl border-[#FF7A30] lg:hover:translate-y-10 lg:hover:scale-105 lg:hover:rounded-t-md group transition duration-300 relative ">
            ...
            <div className="buttons bg-white flex items-center justify-center w-full h-full border-4 rounded-xl border-[#FF7A30] lg:hover:translate-y-10 lg:hover:scale-105 lg:hover:rounded-t-md group transition duration-300 relative ">
