...
const hero = () => {
  return (
    ...
    <div className="images bg-center bg-cover bg-no-repeat w-full lg:h-screen h-full flex flex-col justify-center items-center font-[900]">
        <div className=" w-[90%] h-[95%] items-center flex flex-col pt-8 px-22 lg:space-y-4 space-y-2 ">
          ...
          <div className="overflow-hidden w-fit lg:h-32 items-center justify-center flex">
            ...
            className=" border-2 py-2 lg:px-8 px-1 rounded-l-full border-[#333] border-r-0 lg:text-lg text-xs font-semibold text-center ">Landing page design</motion.p>
            <motion.p
                initial={{ y:100 }}
                animate={{ y:0 }}
                transition={{
            ...
            className=" border-2 py-2 lg:px-8 px-4 border-[#333] lg:text-lg text-xs font-semibold text-center ">Logo design</motion.p>
            <motion.p
                initial={{ y:100 }}
                animate={{ y:0 }}
                transition={{
            ...
            className=" border-2 py-2 lg:px-8 px-4 rounded-r-full border-[#333] border-l-0 lg:text-lg text-xs font-semibold text-center ">Portfolio design</motion.p>
          </div>
          <div className="CTAS flex lg:space-x-4 space-x-2 justify-center ">
            <button className="herobuttons lg:py-3 py-2 hover:scale-110 transition duration-300 lg:w-80 w-40 lg:text-xl text-xs border-2 border-[#333] bg-white hover:bg-[#fffcce] rounded-full buttons ">Join Us NOW</button>
            <button className="herobuttons lg:py-3 py-2 hover:scale-110 transition font-[400] duration-300 lg:w-80 w-40 lg:text-xl text-xs border-2 border-[#fff] bg-[#FF995F] hover:bg-[#FF995F]/80 text-white rounded-full buttons ">See OUR designs</button>
          </div>
          <motion.div
            initial={{
              opacity:0,
