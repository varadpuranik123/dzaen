...
const Faq = () => {
    ...
    return (
        <div className="w-full h-screen border flex flex-col justify-center items-center">
            <div className="faq-container w-[90%] h-[80%] border-t-[2px] py-10 border-[#FF7A30] flex">
                <div className="w-1/2 h-full">
                    <p className="text-6xl font-[400] max-w-[26rem] leading-[1.15] tracking-tight">You Got Any Questions <span className="text-[#FF7A30] font-bold">Boss</span></p>
                </div>
                <div className="w-1/2 flex flex-col h-full ">
                    <div className="w-full h-fit ">
                        <details className={`w-full ${isOpen[0] ? 'h-auto' : 'h-14'} border-t-2 border-[#FF7A30] `} onClick={() => toggleDetails(0)}>
                            <summary className="w-full h-16 flex items-center px-4 justify-between">
                                <p className="text-xl font-[400]">How do I get started?</p>
                                <Image className={`transform ${isOpen[0] ? 'rotate-45' : 'rotate-0'} transition`} src='./plus.svg' alt={''} width={20} height={20}></Image>
                            </summary>
                            <div className={`px-4 py-3 text-xl text-[#333]/60 ${isOpen[0] ? 'block' : 'hidden'}`}>
                        ...
                        <details className={`w-full ${isOpen[5] ? 'h-auto' : 'h-14'} border-t-2 border-[#FF7A30] `} onClick={() => toggleDetails(5)}>
                            <summary className="w-full h-16 flex items-center px-4 justify-between">
                                <p className="text-xl font-[400]">How long does it take to create a landing page?</p>
                                <Image className={`transform ${isOpen[5] ? 'rotate-45' : 'rotate-0'} transition`} src='./plus.svg' alt={''} width={20} height={20}></Image>
                            </summary>
                            <div className={`px-4 py-3 text-xl text-[#333]/60 ${isOpen[5] ? 'block' : 'hidden'}`}>
                        ...
                        <details className={`w-full ${isOpen[1] ? 'h-auto' : 'h-14'} border-t-2 border-[#FF7A30] `} onClick={() => toggleDetails(1)}>
                            <summary className="w-full h-16 flex items-center px-4 justify-between">
                                <p className="text-xl font-[400]">Can I request changes to my landing page after it's been created?</p>
                                <Image className={`transform ${isOpen[1] ? 'rotate-45' : 'rotate-0'} transition`} src='./plus.svg' alt={''} width={20} height={20}></Image>
                            </summary>
                            <div className={`px-4 py-3 text-xl text-[#333]/60 ${isOpen[1] ? 'block' : 'hidden'}`}>
                        ...
                        <details className={`w-full ${isOpen[2] ? 'h-auto' : 'h-14'} border-t-2 border-[#FF7A30] `} onClick={() => toggleDetails(2)}>
                            <summary className="w-full h-16 flex items-center px-4 justify-between">
                                <p className="text-xl font-[400]">Do you provide hosting services for landing pages?</p>
                                <Image className={`transform ${isOpen[2] ? 'rotate-45' : 'rotate-0'} transition`} src='./plus.svg' alt={''} width={20} height={20}></Image>
                            </summary>
                            <div className={`px-4 py-3 text-xl text-[#333]/60 ${isOpen[2] ? 'block' : 'hidden'}`}>
                        ...
                        <details className={`w-full ${isOpen[3] ? 'h-auto' : 'h-14'} border-t-2 border-[#FF7A30] `} onClick={() => toggleDetails(3)}>
                            <summary className="w-full h-16 flex items-center px-4 justify-between">
                                <p className="text-xl font-[400]">What happens if I'm not satisfied with the final result?</p>
                                <Image className={`transform ${isOpen[3] ? 'rotate-45' : 'rotate-0'} transition`} src='./plus.svg' alt={''} width={20} height={20}></Image>
                            </summary>
                            <div className={`px-4 py-3 text-xl text-[#333]/60 ${isOpen[3] ? 'block' : 'hidden'}`}>
                        ...
                        <details className={`w-full ${isOpen[4] ? 'h-auto' : 'h-14'} border-t-2 border-b-2 border-[#FF7A30] `} onClick={() => toggleDetails(4)}>
                            <summary className="w-full h-16 flex items-center px-4 justify-between">
                                <p className="text-xl font-[400]">Can I upgrade or downgrade my plan at any time?</p>
                                <Image className={`transform ${isOpen[4] ? 'rotate-45' : 'rotate-0'} transition`} src='./plus.svg' alt={''} width={20} height={20}></Image>
                            </summary>
                            <div className={`px-4 py-3 text-xl text-[#333]/60 ${isOpen[4] ? 'block' : 'hidden'}`}>
