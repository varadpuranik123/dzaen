  ...
  return (
    <div className="  w-full min-h-[100vh] flex flex-col justify-center items-center " >
        <div className="mt-32 w-full text-center space-y-2">
            <p className=" text-[#333] lg:text-6xl text-4xl px-1 lg:px-0 font-semibold ">There is Somethings We Want to Show <span className="text-[#FF995F] font-bold ">Boss</span></p>
            <p className=" text-[#333]/80 font-semibold text-xs lg:text-lg ">Explore Our Showcase of Standout Projects</p>
        </div>
        <div className="mt-10 project-section flex flex-col-reverse lg:gap-y-0 gap-y-10 lg:flex-row w-[80%] lg:h-[80vh] h-full ">
            <div className="lg:w-[30%] w-full lg:h-full h-96 flex flex-col justify-center items-center border-l-2 border-t-2 border-b-2 rounded-r-lg border-r buttons-2  border-black  ">
            ...
            <div className="rounded-xl lg:ml-10 lg:w-[70%] h-full flex justify-center items-center">
