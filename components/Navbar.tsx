  ...
  return (
    <div id="nav" className=" z-[90]  w-full flex overflow-hidden">
      <nav className="navbar bg-[#fffff7] w-full h-full lg:flex flex-col lg:flex-row items-center justify-between lg:px-10 px-0 py-2 ">
        ...
        <div className={` lg:w-[58%] w-full bg-[#fffff7] absolute lg:translate-y-0 lg:space-y-0 space-y-2 lg:right-10 right-0  lg:h-fit h-1/2 lg:rounded-none rounded-b-xl lg:border-none border-b-2 border-[#333] justify-between lg:flex items-center transition-all ${isOpen ? 'translate-x-0 opacity-100 z-[90] px-2 lg:px-0 ' : 'lg:-z-[0] -z-[90] lg:opacity-100 opacity-0 translate-x-100'}`}>
          <div className="nav-elem lg:flex lg:space-x-8 lg:space-y-0 space-y-4 bg-white buttons-2 border-2 border-[#333] rounded-lg lg:w-auto px-10 py-4 ">
            <p className="text-[#333]/40 hover:text-[#333] text-center transition-all duration-200 cursor-pointer lg:text-base text-2xl "><a href="#">Home</a></p>
            <p className="text-[#333]/40 hover:text-[#333] text-center transition-all duration-200 cursor-pointer lg:text-base text-2xl "><a href="#about">About</a></p>
            <p className="text-[#333]/40 hover:text-[#333] text-center transition-all duration-200 cursor-pointer lg:text-base text-2xl "><a href="#project">Work</a></p>
            <p className="text-[#333]/40 hover:text-[#333] text-center transition-all duration-200 cursor-pointer lg:text-base text-2xl "><a href="#plans">Plans</a></p>
          </div>
          <div className="nav-button">
            <button className="lg:w-auto w-full px-12 py-2 buttons-2 hover:bg-[#fffcce] transition duration-200 font-semibold bg-white border-2 border-[#333] rounded-lg "> Contact Us</button>
          </div>
