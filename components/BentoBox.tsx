  ...
  return (
    <div className="flex flex-col items-center w-full lg:h-[119vh] lg:pt-0 pt-16">
      <div className="w-full text-center space-y-2">
        <p className="text-[#333] lg:text-6xl text-4xl font-semibold">
          <span className="text-[#FF995F] font-bold">Boss,</span> Explore Our Digital Mastery!
        </p>
        <p className="text-[#333]/80 font-semibold lg:text-lg text-xs">Unlock Your Brand&apos;s Potential Online.</p>
      </div>
      <div className="w-[90%] flex flex-col lg:flex-row h-full lg:space-x-4 lg:space-y-0 space-y-4 mt-10">
        <div className="w-full h-full space-y-4 flex flex-col">
          <div className="overflow-hidden flex flex-col justify-center items-center text-start lg:p-10 p-6 buttons w-full h-full border-[2px] border-[#333] rounded-xl">
          ...
          <div className="py-2 overflow-hidden items-center text-start flex flex-col justify-center lg:p-10 p-6 buttons w-full h-full border-[2px] border-[#333] rounded-xl">
        ...
        <div className="w-full flex flex-col space-y-4 h-full">
          <div className="overflow-hidden items-center text-start flex flex-col justify-center lg:p-10 p-8 buttons w-full h-full border-[2px] border-[#333] rounded-xl">
            <div className="w-[90%] h-[90%] flex justify-center items-center ">
              <Image src="./visual.svg" className="-translate-y-6 mt-1 lg:w-full lg:h-full w-72 h-28 object-fil" alt={""} width={0} height={0}></Image>
            </div>
            <div className="w-full">
          ...
          <div className="lg:py-2 overflow-hidden space-y-2 items-center text-start flex flex-col justify-center lg:p-10 p-8 buttons w-full lg:h-full border-[2px] border-[#333] rounded-xl">
